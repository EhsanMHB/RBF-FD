...
function OptionPrice=RBFFDEuropeanput2BE() % put option using BE scheme
format long e
% clear all
clc
%%%%%%%%%%%%%%%%%%%%%% Inputing Parameters %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N=1024; % number of centers
c=10; % the value of constant shape parameter
...
for n=1:M      %%%% Main Part
    RHS(:,n)=-V(:,n);
    RHS(1,n)=RHS(1,n)-A1(1,1)*U(1,n+1);
    RHS(N-2,n)=RHS(N-2,n)-A1(3,N-2)*U(2,n+1);
    %%%%%%%%% system solving %%%%%%%%%%%%
    V(:,n+1)=A\RHS(:,n);
end
OptionPrice= V(:,M+1)